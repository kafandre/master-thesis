...
loaded_model_1 = ComponentwiseBoostingModel.load_model("./checkpoints/mse_model_iteration_1000.pt")
loaded_model_2 = ComponentwiseBoostingModel.load_model("./checkpoints/flooding_model_iteration_1000.pt")
